...
namespace DurableFunctionsMonitor.DotNetBackend
{
  ...
  public class DfmSettings
  {
    ...
    /// <summary>
    /// list of Groups that are allowed to access DurableFunctionsMonitor endpoint. Users then need to be 
    /// assigned one of these groups.
    /// </summary>
  ...
  public static class DfmEndpoint
  {
    ...
    public static void Setup(DfmSettings settings = null, DfmExtensionPoints extensionPoints = null)
    {
      ...
      if (_settings == null)
      {
        ...
        string dfmAllowedGroups = Environment.GetEnvironmentVariable(EnvVariableNames.DFM_ALLOWED_GROUPS);
        ...
        _settings = new DfmSettings()
        {
          ...
          AllowedGroups = dfmAllowedGroups == null ? null : dfmAllowedGroups.Split(','),
